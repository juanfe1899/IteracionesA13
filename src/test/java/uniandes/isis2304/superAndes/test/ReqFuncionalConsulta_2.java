 ...
 *
 */
public class ReqFuncionalConsulta_2
{
	/* ****************************************************************
	 * 			Constantes
	 *****************************************************************/
	 ...
	 */
	private static Logger log = Logger.getLogger(ReqFuncionalConsulta_2.class.getName());
	...
	@Test
	public void unicidadReqFuncional_11() 
	{
...
//			e.printStackTrace();
		...
		try
		{
			...
			List<Promocion> promocionesPopulares = Superandes.requerimientoConsulta2();
			assertEquals("No hay promociones!, deberia ser cero", 0, promocionesPopulares.size());
		}
