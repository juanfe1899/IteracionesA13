...
CANTIDAD_EN_CARRITOS NUMBER NOT NULL,
CANTIDAD NUMBER NOT NULL,
...
CONSTRAINT CHK_CANTIDAD_EN_CAR CHECK (CANTIDAD >= 0)
);
...
CREATE TABLE CARRITO_COMPRAS(
    ...
    CONSTRAINT PK_CARRITO_C PRIMARY KEY(ID_CARRITO_COMPRAS),
...
CREATE TABLE CONTENIDO_CARRITO(
    ...
    CONSTRAINT PK_CONTENIDO_CARRITO PRIMARY KEY(ID_CARRITO_COMPRAS,ID_PRODUCTO_SUCURSAL, ID_ESTANTE),
    CONSTRAINT FK_PRODUCTO_CAR_SUC FOREIGN KEY (ID_PRODUCTO_SUCURSAL) REFERENCES PRODUCTOS_SUCURSAL(ID),
    CONSTRAINT FK_ESTANTE_PROD FOREIGN KEY (ID_ESTANTE) REFERENCES ESPACIO_ACOMODACION(ID),
